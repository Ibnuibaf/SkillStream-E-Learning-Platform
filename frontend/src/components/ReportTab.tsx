  ...
  return (
    <div className="h-screen">
      ...
      <div className="flex justify-center mt-16  w-full">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg h-[75vh] max-w-7xl">
            ...
            {enrollementsList && (
              <tbody>
                {enrollementsList.map((enroll) => (
                  ...
                  >
                    <td className="px-6 py-4">{"Enr00098734"+enroll._id}</td>
                    ...
                    <td className="px-6 py-4">{enroll.courseId.title}</td>
                    <td className="px-6 py-4 text-red-600">
                      {enroll.userId.name}
                    </td>
                    <td className="px-6 py-4">&#8377; {enroll.price}/-</td>
                    <td className="px-6 py-4 text-pink-700 font-bold">&#8377; {Math.floor(0.2*enroll.price)}/-</td>
                  </tr>
                ))}
              </tbody>
            )}
